...
public struct HistoryChanged : IFlatbufferObject
{
	private Table __p;
	...
	public static HistoryChanged GetRootAsHistoryChanged(ByteBuffer _bb)
	{
		return GetRootAsHistoryChanged(_bb, default(HistoryChanged));
	}

	public static HistoryChanged GetRootAsHistoryChanged(ByteBuffer _bb, HistoryChanged obj)
	{
	...
	public HistoryChanged __assign(int _i, ByteBuffer _bb)
	{
		__init(_i, _bb);
		return this;
	}
	...
	public static Offset<HistoryChanged> CreateHistoryChanged(FlatBufferBuilder builder, StringOffset pixIdOffset = default(StringOffset), StringOffset uriOffset = default(StringOffset))
	{
		builder.StartTable(2);
		AddUri(builder, uriOffset);
		AddPixId(builder, pixIdOffset);
		return EndHistoryChanged(builder);
	}

	public static void StartHistoryChanged(FlatBufferBuilder builder)
	{
		builder.StartTable(2);
	}
	...
	public static Offset<HistoryChanged> EndHistoryChanged(FlatBufferBuilder builder)
	{
		return new Offset<HistoryChanged>(builder.EndTable());
	}
}

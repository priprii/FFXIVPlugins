...
public struct InstallExtension : IFlatbufferObject
{
	private Table __p;
	...
	public static InstallExtension GetRootAsInstallExtension(ByteBuffer _bb)
	{
		return GetRootAsInstallExtension(_bb, default(InstallExtension));
	}

	public static InstallExtension GetRootAsInstallExtension(ByteBuffer _bb, InstallExtension obj)
	{
	...
	public InstallExtension __assign(int _i, ByteBuffer _bb)
	{
		__init(_i, _bb);
		return this;
	}
	...
	public static Offset<InstallExtension> CreateInstallExtension(FlatBufferBuilder builder, StringOffset extensionIdOffset = default(StringOffset), StringOffset extensionNameOffset = default(StringOffset))
	{
		builder.StartTable(2);
		AddExtensionName(builder, extensionNameOffset);
		AddExtensionId(builder, extensionIdOffset);
		return EndInstallExtension(builder);
	}

	public static void StartInstallExtension(FlatBufferBuilder builder)
	{
		builder.StartTable(2);
	}
	...
	public static Offset<InstallExtension> EndInstallExtension(FlatBufferBuilder builder)
	{
		return new Offset<InstallExtension>(builder.EndTable());
	}
}

...
public struct DisableExtension : IFlatbufferObject
{
	private Table __p;
	...
	public static DisableExtension GetRootAsDisableExtension(ByteBuffer _bb)
	{
		return GetRootAsDisableExtension(_bb, default(DisableExtension));
	}

	public static DisableExtension GetRootAsDisableExtension(ByteBuffer _bb, DisableExtension obj)
	{
	...
	public DisableExtension __assign(int _i, ByteBuffer _bb)
	{
		__init(_i, _bb);
		return this;
	}
	...
	public static Offset<DisableExtension> CreateDisableExtension(FlatBufferBuilder builder, StringOffset extensionIdOffset = default(StringOffset), StringOffset extensionNameOffset = default(StringOffset))
	{
		builder.StartTable(2);
		AddExtensionName(builder, extensionNameOffset);
		AddExtensionId(builder, extensionIdOffset);
		return EndDisableExtension(builder);
	}

	public static void StartDisableExtension(FlatBufferBuilder builder)
	{
		builder.StartTable(2);
	}
	...
	public static Offset<DisableExtension> EndDisableExtension(FlatBufferBuilder builder)
	{
		return new Offset<DisableExtension>(builder.EndTable());
	}
}

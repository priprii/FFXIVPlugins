...
public static class UIShared
{
	...
	private sealed class _003C_003Ec
	{
		...
		public static Action<IFontAtlasBuildToolkitPreBuild> _003C_003E9__138_2;

		public static FontAtlasBuildStepDelegate _003C_003E9__138_0;

		public static Action<IFontAtlasBuildToolkitPreBuild> _003C_003E9__138_3;

		public static FontAtlasBuildStepDelegate _003C_003E9__138_1;

		internal void _003CInitialize_003Eb__138_0(IFontAtlasBuildToolkit e)
		{
		...
		internal void _003CInitialize_003Eb__138_2(IFontAtlasBuildToolkitPreBuild tk)
		{
			//IL_0016: Unknown result type (might be due to invalid IL or missing references)
			SafeFontConfig val = default(SafeFontConfig);
			((SafeFontConfig)(ref val))._002Ector();
		...
		internal void _003CInitialize_003Eb__138_1(IFontAtlasBuildToolkit e)
		{
			FontAtlasBuildToolkitUtilities.OnPreBuild(e, (Action<IFontAtlasBuildToolkitPreBuild>)delegate(IFontAtlasBuildToolkitPreBuild tk)
			{
				//IL_0016: Unknown result type (might be due to invalid IL or missing references)
		...
		internal void _003CInitialize_003Eb__138_3(IFontAtlasBuildToolkitPreBuild tk)
		{
			//IL_0016: Unknown result type (might be due to invalid IL or missing references)
			SafeFontConfig val = default(SafeFontConfig);
			((SafeFontConfig)(ref val))._002Ector();
	...
	internal static Vector2 WindowPadding => new Vector2(4f, 0f) * ImGuiHelpers.GlobalScale;

	internal static float LineHeight => 26f * ImGuiHelpers.GlobalScale;

	internal static float ItemSpacing => 4f * ImGuiHelpers.GlobalScale;

	internal static float IndentWidth => 12f * ImGuiHelpers.GlobalScale;
	...
	public static void Initialize(Configuration config, IServiceContext services)
	{
		...
		object obj = _003C_003Ec._003C_003E9__138_0;
		if (obj == null)
		{
		...
		if (obj2 == null)
		{
			...
			_003C_003Ec._003C_003E9__138_1 = val2;
			obj2 = (object)val2;
		}

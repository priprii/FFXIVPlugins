...
public static class GameObjectEx
{
	...
	public unsafe static Character* ToCsCharacter(this ICharacter o)
	{
		return (Character*)((IGameObject)o).Address;
	}
	...
	public unsafe static BattleChara* ToCsBattleChara(this IBattleChara o)
	{
	...
	public unsafe static EventObject* ToCsEventObject(this IGameObject o)
	{
		return (EventObject*)o.Address;
	}

	public unsafe static EventObject* ToCsEventObject(this IEventObj o)
	{
		return (EventObject*)((IGameObject)o).Address;
	}

	public unsafe static HousingObject* ToCsHousingObject(this IGameObject o)
	{
		return (HousingObject*)o.Address;
	}

	public unsafe static AreaObject* ToCsAreaObject(this IGameObject o)
	{
		return (AreaObject*)o.Address;
	}

	public unsafe static HousingCombinedObject* ToCsHousingCombinedObject(this IGameObject o)
	{
		return (HousingCombinedObject*)o.Address;
	}

	public unsafe static HousingEventObject* ToCsHousingEventObject(this IGameObject o)
	{
		return (HousingEventObject*)o.Address;
	}

	public unsafe static GatheringPointObject* ToCsGatheringPointObject(this IGameObject o)
	{
		return (GatheringPointObject*)o.Address;
	}

	public unsafe static ReactionEventObject* ToCsReactionEventObject(this IGameObject o)
	{
		return (ReactionEventObject*)o.Address;
	}

	public unsafe static BgObject* ToCsBgObject(this IGameObject o)
	{
		return (BgObject*)o.Address;
	}

	public unsafe static DrawObject* ToCsDrawObject(this IGameObject o)
	{
		return (DrawObject*)o.Address;
	}
	...
	public static bool HasOnlineStatus(this IPlayerCharacter pc, OnlineStatusType status)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
